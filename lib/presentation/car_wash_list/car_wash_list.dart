...
import 'car_wash_list_wm.dart';

@RoutePage()
class CarWashListScreen extends ElementaryWidget<CarWashListWm> with LoggerMixin {
  CarWashListScreen({super.key}) : super((context) => CarWashListWm());
  ...
  Column _noItemsWidget(CarWashListWm wm) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.center,
  ...
  Widget _newPageErrorWidget(CarWashListWm wm) {
    return Container(
      height: 50.h,
      width: 50.w,
  ...
  Column _firstPageErrorWidget(CarWashListWm wm) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.center,
      mainAxisSize: MainAxisSize.max,
      children: [
