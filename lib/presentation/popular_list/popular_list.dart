...
import 'popular_list_wm.dart';

@RoutePage()
class PopularListScreen extends ElementaryWidget<PopularListWm> with LoggerMixin {
  PopularListScreen({super.key, this.perPage}) : super((context) => PopularListWm());
  ...
  Widget _newPageErrorWidget(PopularListWm wm) {
    return Container(
      height: 50.h,
      width: 50.w,
